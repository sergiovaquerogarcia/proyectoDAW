...
<html lang="es">
    <head>
        <title>Zona FAMILIAS. Beauty And Shop</title>
        <meta charset="utf-8">
...
<body>
    ...
    <?php if (isset($_REQUEST["nombreFamilia"]) && (!empty($_REQUEST["nombreFamilia"]))){
        ?>
            <div class="smsOk"><b>La Categoria <?php echo $_REQUEST["nombreFamilia"] ?> se ha borrado correctamente.</b></div><br><br>
        <?php 
        }
        ?>
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-8 menuBotones">
                <div class="text-center menuCategorias">
                    <a href="/beautyandshop/familias/nuevaFamilia.php"><button type="button" class="btn btn-warning text-center">NUEVA</button></a>
                    <a href="/beautyandshop/familias/buscarFamilia.php"><button type="button" class="btn btn-warning text-center">BUSCAR</button></a>
                    <a href="/beautyandshop/familias/zonaFamilias.php?ordenar=1"><button type="button" class="btn btn-warning text-center">ORDENAR ASC</button></a>
                    <a href="/beautyandshop/familias/zonaFamilias.php?ordenar=2"><button type="button" class="btn btn-warning text-center">ORDENAR ASC</button></a>
                </div>
                
                <?php
                $datosFamilias = [];
                //$ordenar = 1;
                $datosFamilias = llenarArrayFamilias($ordenar);
                echo mostrarFamilias ($datosFamilias);
                ?>
            </div>

...
<html lang="es">
<head>
    <title>Formulario Búsqueda FAMILIAS. BeautyAndShop</title>
    <meta charset="utf-8">
            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
                ...
                if(isset($_REQUEST["enviar"])) {
                    if (isset ($nombreBuscar)) {
                        ...
                        $i=0;
                        $cnn = conectar_db();
                        $stmt = $cnn->prepare("SELECT * FROM familias WHERE nombre LIKE '%$nombreBuscar%'");
                        $rows = $stmt->execute();
                        ...
                        if ($totalRegistros == 0 ) {
                        ?>
                            <div class="smsError"><b>ERROR!!! No existen FAMILIAS con esos criterios de busqueda.</b></div><br><br>
                        <?php
                        }
                        else {
                            if ($rows == 1) {

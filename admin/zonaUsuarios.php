            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
                ...
                ?>
                    ...
                    <div class="text-center menuCategorias">
                        <a href="/beautyandshop/registrarse.php?tipo=1"><button type="button" class="btn btn-warning text-center">NUEVO</button></a>
                        <a href="/beautyandshop/admin/buscarUsuario.php"><button type="button" class="btn btn-warning text-center">BUSCAR</button></a>
                        <a href="/beautyandshop/admin/zonaUsuarios.php?ordenar=1"><button type="button" class="btn btn-warning text-center">ORDENAR ASC</button></a>
                        <a href="/beautyandshop/admin/zonaUsuarios.php?ordenar=2"><button type="button" class="btn btn-warning text-center">ORDENAR DESC</button></a>
                    </div>
                <?php
                }
                if($tipo == 2 || $tipoUsuario == 2) {
                    ?>
                        <br >
                        <div class="text-center menuCategorias">
                            <a href="/beautyandshop/registrarse.php?tipo=2"><button type="button" class="btn btn-warning text-center">NUEVO</button></a>
                            <a href="/beautyandshop/admin/buscarUsuario.php"><button type="button" class="btn btn-warning text-center">BUSCAR</button></a>
                            <a href="/beautyandshop/admin/zonaUsuarios.php?ordenar=1"><button type="button" class="btn btn-warning text-center">ORDENAR ASC</button></a>
                            <a href="/beautyandshop/admin/zonaUsuarios.php?ordenar=2"><button type="button" class="btn btn-warning text-center">ORDENAR DESC</button></a>
                        </div>

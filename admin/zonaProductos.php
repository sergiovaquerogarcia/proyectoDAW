<?php 
    ...
    $stmt =$cnn->prepare("Select * from clientes where dni = :dni");
...
<html lang="es">
    <head>
        <title>Zona PRODUCTOS. Beauty And Shop</title>
        <meta charset="utf-8">
    ...
    <section class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-8 menuBotones">
                <?php if (isset($_REQUEST["nombreproducto"]) && (!empty($_REQUEST["nombreproducto"]))){
                ?>
                    <div class="smsOk"><b>El Producto <?php echo $_REQUEST["nombreproducto"] ?> se ha borrado correctamente.</b></div><br><br>
                <?php 
                }
                ?>
                <?php
                ...
                ?>
                    <div class="text-center menuCategorias">
                        <a href="/beautyandshop/admin/nuevoProducto.php"><button type="button" class="btn btn-warning text-center">NUEVO</button></a>
                        <a href="/beautyandshop/admin/buscarArticulos.php"><button type="button" class="btn btn-warning text-center">BUSCAR</button></a>
                        <a href="/beautyandshop/admin/zonaProductos.php?ordenar=1"><button type="button" class="btn btn-warning text-center">ORDENAR ASC</button></a>
                        <a href="/beautyandshop/admin/zonaProductos.php?ordenar=2"><button type="button" class="btn btn-warning text-center">ORDENAR DESC</button></a>
                    </div>
                <?php
                }
                ...
                <?php
                    $datosProductos = [];
                    //$ordenar = 0;
                    $datosProductos = llenarArrayProductos($ordenar);

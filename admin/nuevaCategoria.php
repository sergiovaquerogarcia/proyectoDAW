<?php
    ...
    if(isset($_REQUEST["enviar"]) == TRUE) {
        ...
        if (!isset($codigo0) && !isset($codigo1)) {
            addCategoria ($tipo, strtoupper($nombreCategoria), $activoCategoria, $categoriaPadre);
        }
    }
?>
<html lang="es">
    <head>
        <title>Nueva Categoria. Beauty And Shop</title>
        <meta charset="utf-8">
    ...
    <section class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
                <h2 class="h3 text-center text-warning">NUEVA CATEGORIA</h2><hr><br>
                <form method="post" action="">
                    <div class="form-group">
                        <label for="nombreCategoria" class="col-sm-12 col-form-label text-warning"><h5>NOMBRE CATEGORIA</h5></label>
                        <div class="col-sm-12">
                           <input class="form-control errorImput" type="text" required maxlength="50" size="50" name="nombreCategoria" value="<?php if(isset($nombreCategoria)) echo $nombreCategoria ?>" <?php if(isset($codigo0) && $codigo0 == 0){ echo "autofocus"; } ?>>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select class="form-control" id="categoriaPadre" name="categoriaPadre" required>

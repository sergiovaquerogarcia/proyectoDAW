<?php
    ...
    if(isset($_REQUEST["eliminar"]) == TRUE) {
        ...
        $rows = $stmt->execute(array(":activo"=>$activo, ":codUsuario"=>$cusu));
        if ($rows == 1) {       
            if ($tipo == 1) {
                //header("location: zonaAdministrador.php?nombreusuario= " . $nombre);
            }
            else {
                session_start();
                $_SESSION = array(); 
                session_destroy();
                header("location:/beautyandshop/index.php?nombreusuario= " . $nombre);
    ...
    <section class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
                ...
                <h4 class="h4 text-center text-danger">¿Está seguro que quiere eliminar su Usuario?</h4>
                <div class="text-center">
                    <h5 class="h5 text-info">Nombre Usuario:</h5> <span><strong><?php echo $nombre;?></strong></span>
                    <h5 class="h5 text-info">Código:</h5> <span><strong><?php echo $cusu;?></strong></span><br>
                </div><br><br><hr>

...
<head>
    ...
    <title>Editar Cita. BeautyAndShop</title>
...
<body>
    ...
    <div class="imagenAgenda jumbotron jumbotron-fluid">
        <div class="container-fluid">
            <h1 class="display-4 text-dark">Editar Cita</h1>
    ...
    <script>
        ...
        var codCita = '<?php echo $codCita;?>';
    </script>
    <script src="/beautyandshop/js/scriptEditarCita.js" defer></script>

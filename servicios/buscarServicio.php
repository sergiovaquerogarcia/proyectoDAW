...
<html lang="es">
<head>
    <title>Formulario Búsqueda SERVICIOS. BeautyAndShop</title>
    <meta charset="utf-8">
                ...
                <?php
                    if(isset($_REQUEST["enviar"])) {
                        if (isset ($nombreBuscar)) {
                            ...
                            $i=0;
                            $cnn = conectar_db();
                            $stmt = $cnn->prepare("SELECT * FROM servicios WHERE descripcion LIKE '%$nombreBuscar%' ORDER BY descripcion ASC");
                            $rows = $stmt->execute();
                            ...
                            if ($totalRegistros == 0 ) {
                            ?>
                            <div class="smsError"><b>ERROR!!! NO EXISTEN SERVICIOS CON ESOS CRITERIOS DE BÚSQUEDA.</b></div><br><br>
                            <?php
                            }
                            else {
                                if ($rows == 1) {
                                    ...
                                    echo mostrarServicios ($datosServicios, $tipoUsuario);
                                }
                            }                                  
                        }
